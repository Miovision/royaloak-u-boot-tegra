 ...
 * Run "board-to-uboot.py royaloak-ctm".
 */

#ifndef _PINMUX_CONFIG_ROYALOAK_CTM_H_
#define _PINMUX_CONFIG_ROYALOAK_CTM_H_
...
static const struct tegra_gpio_config royaloak_ctm_gpio_inits[] = {
	/*        port, pin, init_val */
	GPIO_INIT(A,    5,   IN),
	GPIO_INIT(A,    6,   OUT1),
	GPIO_INIT(B,    7,   OUT1),
...
static const struct pmux_pingrp_config royaloak_ctm_pingrps[] = {
	...
	PINCFG(SPI2_CS0_PB7,         DEFAULT,  NORMAL, NORMAL,   OUTPUT,  DISABLE, DEFAULT),
	...
	PINCFG(SPI1_CS0_PC3,         DEFAULT,  NORMAL, NORMAL,   OUTPUT,  DISABLE, DEFAULT),
	...
	PINCFG(DMIC1_CLK_PE0,        DEFAULT,  NORMAL, NORMAL,   INPUT,   DISABLE, DEFAULT),
	PINCFG(DMIC1_DAT_PE1,        DEFAULT,  NORMAL, NORMAL,   OUTPUT,  DISABLE, DEFAULT),
	PINCFG(DMIC2_CLK_PE2,        DEFAULT,  NORMAL, NORMAL,   INPUT,   DISABLE, DEFAULT),
	PINCFG(DMIC2_DAT_PE3,        DEFAULT,  NORMAL, NORMAL,   INPUT,   DISABLE, DEFAULT),
	...
	PINCFG(PE6,                  DEFAULT,  NORMAL, NORMAL,   OUTPUT,  DISABLE, DEFAULT),
	...
	PINCFG(NFC_EN_PI0,           DEFAULT,  NORMAL, NORMAL,   INPUT,   DISABLE, DEFAULT),
	PINCFG(NFC_INT_PI1,          DEFAULT,  NORMAL, NORMAL,   OUTPUT,  DISABLE, DEFAULT),
	PINCFG(GPS_EN_PI2,           DEFAULT,  DOWN,   NORMAL,   INPUT,   DISABLE, DEFAULT),
	...
	PINCFG(DAP4_FS_PJ4,          DEFAULT,  NORMAL, NORMAL,   OUTPUT,  DISABLE, DEFAULT),
	PINCFG(DAP4_DIN_PJ5,         DEFAULT,  NORMAL, NORMAL,   INPUT,   DISABLE, DEFAULT),
	PINCFG(DAP4_DOUT_PJ6,        DEFAULT,  NORMAL, NORMAL,   INPUT,   DISABLE, DEFAULT),
	PINCFG(DAP4_SCLK_PJ7,        DEFAULT,  NORMAL, NORMAL,   OUTPUT,  DISABLE, DEFAULT),
	...
	PINCFG(CAM1_MCLK_PS0,        DEFAULT,  NORMAL, NORMAL,   OUTPUT,  DISABLE, DEFAULT),
	PINCFG(CAM2_MCLK_PS1,        DEFAULT,  NORMAL, NORMAL,   INPUT,   DISABLE, DEFAULT),
	...
	PINCFG(CAM_AF_EN_PS5,        DEFAULT,  NORMAL, NORMAL,   INPUT,   DISABLE, DEFAULT),
	...
	PINCFG(CAM2_PWDN_PT0,        DEFAULT,  NORMAL, NORMAL,   INPUT,   DISABLE, DEFAULT),
	...
	PINCFG(UART1_RX_PU1,         UARTA,    DOWN,   NORMAL,   INPUT,   DISABLE, DEFAULT),
	...
	PINCFG(LCD_BL_PWM_PV0,       DEFAULT,  NORMAL, NORMAL,   INPUT,   DISABLE, DEFAULT),
	...
	PINCFG(LCD_TE_PY2,           DEFAULT,  NORMAL, NORMAL,   OUTPUT,  DISABLE, DEFAULT),
	...
	PINCFG(PZ0,                  DEFAULT,  NORMAL, NORMAL,   OUTPUT,  DISABLE, DEFAULT),
	...
	PINCFG(AUD_MCLK_PBB0,        DEFAULT,  NORMAL, NORMAL,   INPUT,   DISABLE, DEFAULT),
	...
	PINCFG(HDMI_CEC_PCC0,        DEFAULT,  UP,     NORMAL,   INPUT,   DISABLE, NORMAL),
	PINCFG(HDMI_INT_DP_HPD_PCC1, DEFAULT,  NORMAL, NORMAL,   INPUT,   DISABLE, NORMAL),
	...
	PINCFG(USB_VBUS_EN0_PCC4,    USB,      NORMAL, NORMAL,   INPUT,   DISABLE, NORMAL),
	PINCFG(USB_VBUS_EN1_PCC5,    RSVD1,    DOWN,   TRISTATE, OUTPUT,  DISABLE, NORMAL),
	PINCFG(DP_HPD0_PCC6,         DEFAULT,  NORMAL, NORMAL,   OUTPUT,  DISABLE, DEFAULT),
...
static const struct pmux_drvgrp_config royaloak_ctm_drvgrps[] = {
};

#endif /* PINMUX_CONFIG_ROYALOAK_CTM_H */
